        ...
        <div className="mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              ...
              <div className="grid grid-cols-3 gap-4 lg:flex lg:items-center lg:gap-8">
                <div className="text-center">
                  <div className="text-xl md:text-2xl font-bold text-black mb-1">{stats.averageRating}</div>
                  <div className="text-xs md:text-sm font-medium text-gray-600 mb-2">Instructor Rating</div>
                  <div className="flex items-center justify-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className={`w-3 h-3 md:w-4 md:h-4 ${i < Math.floor(stats.averageRating) ? 'text-yellow-400' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="text-center">
                  <div className="text-xl md:text-2xl font-bold text-black mb-1">{stats.totalStudents}</div>
                  <div className="text-xs md:text-sm font-medium text-gray-600">Total Students</div>
                </div>
                <div className="text-center">
                  <div className="text-lg md:text-2xl font-bold mb-1" style={{ color: '#5e17eb' }}>{formatCurrency(stats.monthlyRevenue)}</div>
                  <div className="text-xs md:text-sm font-medium text-gray-600">Monthly Revenue</div>
                </div>
              </div>
            </div>
          </div>
