          ...
          <div className="grid lg:grid-cols-4 gap-6 mb-16">
            ...
            <div className="bg-white border-2 border-black rounded-3xl p-6">
              <div className="text-center">
                <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 bg-[#5e17eb]">
            ...
            {[
              ...
              >
                ...
                <div className="min-h-[400px] p-8 rounded-2xl transition-all duration-300 bg-white border-4 border-[#5e17eb] shadow-2xl hover:shadow-3xl hover:-translate-y-2 hover:border-[#4a12c4] hover:scale-105 hover:bg-[#5e17eb]/5">
                  ...
                  {/* Icon */}
                  <div className="w-14 h-14 rounded-lg flex items-center justify-center mb-6 bg-[#5e17eb]/10 text-[#5e17eb]">
                    {step.icon}
                  </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {[
              ...
              const getCardStyle = (style: string) => {
                return "relative h-full bg-white rounded-2xl p-6 border-2 border-gray-100 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:border-[#5e17eb] group";
              };

              const getIconStyle = (style: string) => {
                return "w-12 h-12 bg-[#5e17eb]/10 rounded-xl flex items-center justify-center text-[#5e17eb] group-hover:bg-[#5e17eb] group-hover:text-white transition-all duration-300";
              };
                ...
                <div key={idx} className="group cursor-pointer">
                  <div className={getCardStyle(category.style)}>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <span className="text-xs font-semibold px-3 py-1 rounded-full text-[#5e17eb] bg-[#5e17eb]/10 group-hover:bg-[#5e17eb] group-hover:text-white transition-all duration-300">
                        {category.courses}
                      </span>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      {/* CTA */}
                      <div className="pt-2">
                        <div className="flex items-center text-sm font-semibold text-[#5e17eb] group-hover:text-[#4a12c4] transition-colors duration-300">
