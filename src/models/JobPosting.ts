...
export const CompanySchema = z.object({
  ...
  contact_email: z.string().email({ message: "Invalid email format" }).optional(),
  contact_phone: z.string().optional(),
  social_links: z.record(z.string(), z.string().url({ message: "Invalid URL format" })).default({}),
  is_verified: z.boolean().default(false),
  verified_at: z.date().optional(),
  verified_by: z.string().uuid({ message: "Invalid UUID format" }).optional(),
...
export const JobAlertSchema = z.object({
  ...
  work_modes: z.array(z.enum([WorkMode.REMOTE, WorkMode.ONSITE, WorkMode.HYBRID])).default([]),
...
export const UpdateJobApplicationSchema = z.object({
  status: z.enum([ApplicationStatus.PENDING, ApplicationStatus.REVIEWED, ApplicationStatus.SHORTLISTED, ApplicationStatus.INTERVIEW_SCHEDULED, ApplicationStatus.REJECTED, ApplicationStatus.HIRED]).optional(),
  interview_scheduled_at: z.date().optional(),
  interview_notes: z.string().optional(),
  interview_feedback: z.string().optional(),
  status_updated_by: z.string().uuid({ message: "Invalid UUID format" }).optional()
